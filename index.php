	...
	<div class="container">
		...
		<main>
			...
			<section class="etui">
				<span>Etui</span>
				<ul class="etui-types">
					<li class="etui-types-card">
						<img src="./images/steklo-chehol.png" alt="Przezroczyste etui">
						<p>Przezroczyste</p>
					</li>

					<li class="etui-types-card">
						<img src="./images/silikon-chehol.png" alt="Silikonowe etui">
						<p>Silikonowe</p>
					</li>

					<li class="etui-types-card">
						<img src="./images/korza-chehol.png" alt="Etui z tkaniny">
						<p>Z tkaniny</p>
					</li>
				</ul>
			</section>
